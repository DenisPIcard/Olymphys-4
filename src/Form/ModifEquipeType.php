...
{   private $session;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $datelim=$this->session->get('datelimphotoscia');//30 jour apès le concours cia.
        new \datetime('now')>$datelim ? $tag=true:$tag = false;//La modification du titre du projet n'est autorisée que 30 jours après les cia
