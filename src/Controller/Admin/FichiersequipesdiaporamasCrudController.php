...
class FichiersequipesdiaporamasCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, '<h2>Les diaporamas</h2>')
            ...
            ->overrideTemplate('crud/index', 'Admin/customizations/list_diaporamas.html.twig');
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        if (Crud::PAGE_INDEX === $pageName) {
            ...
            return [$panel1, $equipe, $typefichier, $fichierFile];
